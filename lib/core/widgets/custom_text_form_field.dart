...
class CustomTextFormFieldWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: textStyle ?? AppTextStyles.specialGothicCondensedOneBold(context, 16),
      ...
      decoration: InputDecoration(
        labelText: labelText,
        labelStyle: labelStyle ?? AppTextStyles.specialGothicCondensedOneBold(context, 16),
        hintText: hintText,
        hintStyle: hintStyle ?? AppTextStyles.specialGothicCondensedOneBold(context, 16),
